...
create table `workplace_category`(
    ...
    name            VARCHAR(40)    not null DEFAULT '',                -- 分类名称
...
create table `workplace_app`(
    ...
    category_no     VARCHAR(40)    not null DEFAULT '',                -- 所属分类编号
    icon            VARCHAR(40)    not null DEFAULT '',                -- 应用icon
    name            VARCHAR(40)    not null DEFAULT '',                -- 应用名称
    `description`   VARCHAR(100)   not null DEFAULT '',                -- 应用介绍
    ...
    `route`         VARCHAR(100)   not null DEFAULT '',                -- 打开地址
    is_paid_app     smallint       not null DEFAULT 0,                 -- 是否为付费应用 0.否 1.是
    created_at      timeStamp      not null DEFAULT CURRENT_TIMESTAMP, -- 创建时间
    updated_at      timeStamp      not null DEFAULT CURRENT_TIMESTAMP  -- 更新时间
);

CREATE INDEX workplace_app_category_no on `workplace_app` (category_no);
...
create  table `workplace_banner`(
    ...
    cover           VARCHAR(40)    not null DEFAULT '',                -- 封面地址
    title           VARCHAR(40)    not null DEFAULT '',                -- 横幅标题
    `description`   VARCHAR(100)   not null DEFAULT '',                -- 横幅介绍
    jump_type       smallint       not null DEFAULT 0,                 -- 打开方式 0.网页 1.原生
    `route`         VARCHAR(100)   not null DEFAULT '',                -- 打开地址
    created_at      timeStamp      not null DEFAULT CURRENT_TIMESTAMP, -- 创建时间
    updated_at      timeStamp      not null DEFAULT CURRENT_TIMESTAMP  -- 更新时间
